 ...
 */
final class Version20241114125508 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE benevole_zone (benevole_id INT NOT NULL, zone_id INT NOT NULL, INDEX IDX_41F7B7B49F2C3FAB (zone_id), INDEX IDX_41F7B7B4E77B7C09 (benevole_id), PRIMARY KEY(benevole_id, zone_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
